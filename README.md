...
For **Mastodon** (*requires the -m option*) your data file is stored within the ***iCCP chunk*** of the PNG image file. For all the other compatible sites listed above, your data file is stored within an IDAT chunk, of the PNG image.
