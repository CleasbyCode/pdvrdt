...
For example, a cover image with **1024x1024** dimensions can store only **~103KB** of data, ***2048x2048*** can store **~418KB** and an image with **4096x4096** dimensions can store **~1.5MB**. 
