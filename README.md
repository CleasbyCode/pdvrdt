...
***pdvrdt*** is a *"steganography-like"* command-line utility. It is split into two CLI tools, ***pdvin***, *used for embedding a data file within a ***PNG*** cover image*, and ***pdvout***, *used for extracting the hidden file from the cover image.*  
