...
// Use the project CRC implementation instead of lodepng's built-in scalar path.
// The external definition runtime-dispatches to PCLMULQDQ folding on x86 CPUs
// that support it and keeps a slicing-by-8 scalar fallback for portability.
