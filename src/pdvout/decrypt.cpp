...
void decryptFile(std::vector<uint_fast8_t>&Image_Vec, std::vector<uint_fast8_t>&File_Vec, std::string& encrypted_file_name) {

	std::string decrypted_file_name;

	constexpr uint_fast8_t XOR_KEY_LENGTH = 6;
