...
// from everything else. It defends position secrecy, not confidentiality --
// the payload underneath is still secretstream-encrypted under the Argon2 key --
// so it does not need to be slow, and being fast keeps a wrong PIN cheap to
// reject.
