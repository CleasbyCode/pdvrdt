void displayInfo() {
	...
	std::cout << R"(
PNG Data Vehicle (pdvin v1.8). Created by Nicholas Cleasby (@CleasbyCode) 24/01/2023.

A simple command-line tool used to embed any file type via a PNG image file.  
...
Argument options:	
 ...
 -m = Mastodon option, used with -e Embed mode (pdvin -m image.png file.mp3).
 -r = Reddit option, used with -e Embed mode (pdvin -r image.png file.doc).
